...
class Candor < Formula
  ...
  url "https://github.com/tombaldwin/candor/archive/refs/tags/v0.37.0.tar.gz"
  sha256 "b0343d1fab4385f436cd176726ff0830c7d18be4cbd8ea7554adf8b30fa0b9a0" # filled at ship by update-candor.sh
