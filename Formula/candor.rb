...
class Candor < Formula
  ...
  url "https://github.com/tombaldwin/candor/archive/refs/tags/v0.30.0.tar.gz"
  sha256 "cf3ed8cf06374fd21ca3f4dcf5e43399a27b70b9176684ca5d6b76fb5599bd0e" # filled at ship by update-candor.sh
