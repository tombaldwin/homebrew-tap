...
class Candor < Formula
  ...
  url "https://github.com/tombaldwin/candor/archive/refs/tags/v0.29.1.tar.gz"
  sha256 "9a1227211f46d75b42396cd5835f84d58529694abe97526173b3654b5795ccff" # filled at ship by update-candor.sh
